...
<div class="space-y-6 animate-fade-in">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Add Employee</h1>
            <p class="text-sm text-gray-500 mt-1">Create a new account for your store staff</p>
        </div>
    </div>

    <form action="{{ route('seller.staff.store') }}" method="POST" class="max-w-4xl">
        @csrf
            ...
            <div class="md:col-span-2 space-y-6">
                <div class="card p-6 sm:p-8 space-y-6">
                    ...
                    <div class="pt-4 border-t border-gray-50">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div class="space-y-2">
                                <label for="password" class="text-xs font-bold text-gray-500 uppercase tracking-widest ml-1">Password</label>
                ...
                <div class="card p-6 space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="role" id="role" required
                            class="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-medium focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all">
                            <option value="store_staff" {{ old('role') == 'store_staff' ? 'selected' : '' }}>Store Staff</option>
                    ...
                    <div class="pt-4 border-t border-gray-50 flex flex-col gap-4">
                        <label class="flex items-center gap-3 cursor-pointer group">
                            ...
                            <span class="text-xs font-bold text-gray-600 uppercase tracking-widest group-hover:text-indigo-600 transition-colors">Activate Account</span>
                        </label>
                    </div>
                </div>
                                ...
                                <div class="grid grid-cols-1 gap-2">
                                    @foreach($permissions as $value => $label)
                                        <label class="flex items-center gap-3 p-2 rounded-xl hover:bg-gray-50 transition-colors cursor-pointer border border-transparent hover:border-gray-100">
                                            <input type="checkbox" name="permissions[]" value="{{ $value }}" class="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500/20">
