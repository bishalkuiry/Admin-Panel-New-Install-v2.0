    ...
    <!-- Enable/Disable Toggle -->
        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <label for="paystack_enabled" class="font-medium text-gray-900 cursor-pointer">Enable Paystack</label>
                    <p class="text-xs text-gray-500">Accept payments through Paystack gateway</p>
                </div>
            </div>
            <label class="toggle">
                <input class="toggle-input" type="checkbox" name="enabled" id="paystack_enabled" 
                       value="1" {{ $paymentConfig['gateways']['paystack']['enabled'] ? 'checked' : '' }}>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" class="w-full h-11 pl-10 pr-4 text-sm border border-gray-300 rounded-lg focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition-all" 
                           id="paystack_public_key" name="public_key" 
                           value="{{ $paymentConfig['gateways']['paystack']['public_key'] }}" 
                           placeholder="pk_test_1a3186e7b1d29d1acf2f6162d9f7ae15be92e541">
                </div>
                <p class="text-xs text-gray-500 mt-1">Get this from Paystack Dashboard → Settings → API Keys & Webhooks</p>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="password" class="w-full h-11 pl-10 pr-4 text-sm border border-gray-300 rounded-lg focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition-all" 
                           id="paystack_secret_key" name="secret_key" 
                           value="{{ $paymentConfig['gateways']['paystack']['secret_key'] }}" 
                           placeholder="sk_test_608bc0f5e0f5e67bc1d64f18f7b4f4c09ceec7c3f83ee">
                </div>
