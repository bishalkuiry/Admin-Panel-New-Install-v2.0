        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" value="{{ $category->slug }}" class="input bg-gray-50" disabled>
                            <p class="form-hint">Auto-generated from name</p>
                        </div>
                        <div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="sort_order" value="{{ old('sort_order', $category->sort_order) }}" class="input" min="0">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body" x-data="{ preview: '{{ $category->image ? storage_url($category->image) : '' }}' }">
            ...
            <div class="space-y-6">
                <div class="card">
                    ...
                    <div class="card-body space-y-3">
                        <label class="flex items-center gap-3 p-3 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-50 transition">
                            <input type="checkbox" name="is_active" value="1" {{ $category->is_active ? 'checked' : '' }} class="checkbox">
                            <div>
                        ...
                        <label class="flex items-center gap-3 p-3 rounded-lg border border-gray-200 cursor-pointer hover:bg-gray-50 transition">
                            <input type="checkbox" name="is_featured" value="1" {{ $category->is_featured ? 'checked' : '' }} class="checkbox">
                            <div>
                ...
                <div class="card">
                    ...
                    <div class="card-body space-y-3">
                        ...
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-medium text-gray-900">{{ \App\Helpers\DateHelper::format($category->created_at) }}</span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-500">Updated</span>
                            <span class="font-medium text-gray-900">{{ \App\Helpers\DateHelper::format($category->updated_at) }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex gap-3">
                    ...
                    <button type="submit" class="btn-primary flex-1 justify-center">Update Category</button>
                </div>
            </div>
        </div>
    </form>
