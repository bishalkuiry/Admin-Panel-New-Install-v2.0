...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-xl font-bold text-gray-900 tracking-wide">Add Brand</h1>
                ...
                <div class="card bg-white border border-gray-200 shadow-sm rounded-xl p-6">
                    ...
                    <div class="space-y-5">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" required class="w-full px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm text-gray-900 focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all placeholder:text-gray-400" placeholder="Ex: Nike, Adidas">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                            ...
                            <label class="relative flex items-start p-4 border border-gray-200 rounded-xl cursor-pointer hover:border-primary-500 hover:bg-primary-50/10 transition-all group">
                                <div class="flex items-center h-5">
                                    <input type="checkbox" name="store_ids[]" value="{{ $store->id }}" class="w-4 h-4 text-primary-600 border-gray-300 rounded focus:ring-primary-500 transition-colors">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="flex items-center gap-4">
                                <div class="relative w-16 h-16 rounded-xl bg-gray-100 flex items-center justify-center overflow-hidden border border-gray-200 shrink-0 group">
                                    <img id="logo-preview" src="#" alt="Preview" class="w-full h-full object-contain hidden">
                                    <button type="button" id="remove-logo-btn" onclick="removeLogo()" class="absolute top-0 right-0 p-0.5 bg-gray-900/50 hover:bg-red-500 text-white rounded-bl-lg transition-colors hidden backdrop-blur-sm">
                                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg>
                                    </button>
                                    <svg id="logo-placeholder" class="w-6 h-6 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                                </div>
                                <div class="flex-1">
